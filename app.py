...
if noise_mode == "White noise":
    if noise_snr == 0:
        st.caption(
            "0 dB: Яриа болон шуугиан ойролцоо хүчтэй. "
            "Хамгийн хүнд туршилтын нөхцөл."
        )

    elif noise_snr == 5:
        st.caption(
            "5 dB: Шуугиан хүчтэй хэвээр боловч яриа арай тод."
        )

    elif noise_snr == 10:
        st.caption(
            "10 dB: Дуу чимээг сайн бууруулахын зэрэгцээ яриа байгалийн хэвээр сонсогдоно."
        )

    elif noise_snr == 15:
        st.caption(
            "15 dB:  Оролтын аудио харьцангуй цэвэрхэн тул."
            "RNNoise-ийн нэмэлт нөлөө бага байна."
        )

    elif noise_snr == 20:
        st.caption(
            "20 dB: Оролтын аудио аль хэдийн цэвэрхэн тул "
            "RNNoise-ийн нөлөө маш бага байна."
        )
